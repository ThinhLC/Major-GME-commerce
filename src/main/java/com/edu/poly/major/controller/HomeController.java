    ...
    public class    HomeController {
        ...
        public String home(Model model){
            ...
            model.addAttribute("content1", "index");
            return "Base";
        } //index
        ...
        public String updateUser(Model model){
            ...
            model.addAttribute("content1","userRoleAdd");
            return "Base";
        }
        @PostMapping("/users/add")
        public String postUserAdd(@ModelAttribute("userDTO") UserDTO userDTO, Model model) {
            //convert dto > entity
            User user = new User();
        ...
        public String shop(Model model){
            ...
            model.addAttribute("content1","shop");
            return "Base";
        } //view All Products
        ...
        public String shopByCat(@PathVariable int id, Model model){
            ...
            model.addAttribute("conten1","shop");
            return "Base";
        ...
        public String viewProduct(@PathVariable long id, Model model){
            ...
            model.addAttribute("content1","viewProduct");
            return "Base";
